...
#  Energy PES plot
    ...
    set contour base
    set cntrparam levels discrete 50, 100, 200, 400, 600
    unset surface
    set table 'cont_E.dat'
    splot filename using 2:3:(($4 - Z_min)*Eh2meV)
    unset table
    unset dgrid3d
    ...
    set ytics 40
    set mytics 2
    set palette defined ( 0 '#0000FF', 1 '#6666FF', 2 '#3399FF', 3 '#00FFFF', 4 '#7FFF7F', 5 '#FFFF00', 6 '#FF7F00', 7 '#FF0000') #0 '#0000FF',
    ...
    p filename using 2:3:(($4 - Z_min)*Eh2meV) w image, \
...
#  Dipole Moment Plot
    ...
    set contour base
    set cntrparam levels discrete 0.5, 1.0, 1.5, 2, 2.5, 3, 3.5
    unset surface
    set table 'cont_D.dat'
    splot filename using 2:3:5
    unset table
    unset dgrid3d
    ...
    p filename using 2:3:5 w ima, '<'.sprintf('gawk -f %s cont_D.dat 1 %d %d 1 1', gawk_script, space_width, offset) w l lt -1 lw 3.5 linecolor rgb "black"
...
#  VBS Plot
    ...
    set xlabel '{\normalsize $\Phi$}'
    set ylabel '{\normalsize $\Psi$}' offset 2,0
    set title '{VBS EA (eV)}' offset 0,-0.8
...
# 4 DBS Plot
    ...
    set mytics 2
    set xlabel '{\normalsize $\Phi$}'
    set title '{DBS EA (meV)}' offset 0,-0.8
    set cbrange [-10:14]
