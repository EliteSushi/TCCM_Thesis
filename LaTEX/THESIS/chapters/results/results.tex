...
\iffalse \begin{figure}[ht!]
  ...
  \begin{minipage}[]{0.49\textwidth}
    \centering
    \small
    \input{chapters/results/image/Q0_E.tex}
  \end{minipage}%
  %\hfill
  \begin{minipage}[]{0.47\textwidth}
    \centering
    \small
    \input{chapters/results/image/Q0_d.tex}
  \end{minipage}
  %\vfill
  \begin{minipage}[]{0.49\textwidth}
    \centering
    \small
    \input{chapters/results/image/Q0_VBA.tex}
  \end{minipage}%
  \begin{minipage}[]{0.47\textwidth}
    \centering
    \small
    \input{chapters/results/image/Q0_DBA.tex}
  \end{minipage}
  \label{fig:Q0_surf}
...
\iffalse\begin{figure}[ht!]
  ...
  \begin{minipage}[]{0.49\textwidth}
    \centering
    \footnotesize
    \input{chapters/results/image/Q1_E.tex}
  \end{minipage}%
  %\hfill
  \begin{minipage}[]{0.47\textwidth}
    \centering
    \small
    \input{chapters/results/image/Q1_d.tex}
  \end{minipage}
  %\vfill
  \begin{minipage}[]{0.49\textwidth}
    \centering
    \small
    \input{chapters/results/image/Q1_VBA.tex}
  \end{minipage}%
  \begin{minipage}[]{0.47\textwidth}
    \centering
    \small
    \input{chapters/results/image/Q1_DBA.tex}
  \end{minipage}
  \label{fig:Q1_surf}
