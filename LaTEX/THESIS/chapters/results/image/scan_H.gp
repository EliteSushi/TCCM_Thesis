reset
set terminal cairolatex size 4.85,2.23 
set output 'scan_H.tex'

# Multiplot layout setup
set multiplot layout 2,1 margins 0.1,0.98,0.01,0.98 spacing 0,0.03
...
#    'H2O_Hfirst.dat' u 1:(($2+724.41877228)*1000) w lp lw linew lc rgb "red" title '$\mathrm{H}_2\mathrm{O}$', \
 #   'NH3_Hfirst.dat' u 1:(($2+704.56189668)*1000) w lp lw linew lc rgb "medium-blue" title '$\mathrm{NH}_3$', \
 #   'HF_Hfirst.dat' u 1:(($2+748.41555763)*1000) w lp lw linew lc rgb "web-green" title 'HF', \
 #   0 w l lw 1 lc rgb "black" notitle
