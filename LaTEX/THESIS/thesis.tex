\documentclass[showinstructions,doctoralschool=sci,faculty=dc,department=che,phddegree=tccm]{adsphd}
% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
% !!                                                               !!
...
\subtitle{A Second Order Approximate Coupled Clouster Study}

\author{Mauro}{Gasc{\'o}n Navas}

\supervisor{Robin Moorby}{}
\supervisor{Prof.~Dr.~Thomas Jagau}{}
%\president{}{}
%\jurymember{Prof. Jeremy N. Harvey}{}
%\jurymember{Dr. Mariana Telles do Casal}{}
%\externaljurymember{}{}

% Your research group within the department
% e.g. DTAI, MICAS
\researchgroup{Theoretical Chemistry of Unbound Electrons}
\website{https://chem.kuleuven.be/en/research/qcpc/tue/} % Leave empty to hide
...
\iffalse \usepackage{nomencl}   % For nomenclature
...
\includepopabstractnl{acknowledgements}
...
\useOfGenAI{%
  ...
  Generative AI was used for lenguage and coding assistance (ChatGPT, MicrosoftCopilot, LeChat). 
}
\includegenai{}
