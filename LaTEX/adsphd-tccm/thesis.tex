...
%%% COVER: Settings %%%
\title{A very cool Title:}
\subtitle{An even cooler subtitle}

\author{Peter}{Parker}

\supervisor{Prof.~Dr.~ Otto Octavius}{}
\supervisor{Prof.~Dr.~Norman Osborn}{}
\president{Prof.~Dr.~Thanos}{}
\jurymember{Prof.~Dr.~Tony Stark}{}
\jurymember{Prof.~Dr.~Robert Bruce Banner}{}
\externaljurymember{Prof.~Dr.~Bruce Wayne}{DC Comics}

% Your research group within the department
% e.g. DTAI, MICAS
\researchgroup{A Really Cool Research Group}
\website{https://chem.kuleuven.be/<AReallyCoolResearchGroup>} % Leave empty to hide
