...
\begin{frame}{\huge Potential Energy Surfaces of Q\textsubscript{0}}\large
	\begin{columns}[t]
		...
		\begin{column}{0.50\textwidth}
			The system presents C\textsubscript{2} symmetry
			\begin{itemize}
...
\begin{frame}{\huge Conclusions}\large
	\begin{itemize}
		...
		\item Intermolecular interactions have a larger effect on VBS than methoxy chain rotations
		\item In general, DBS electron binding energy is loosely correlated with dipole strength
